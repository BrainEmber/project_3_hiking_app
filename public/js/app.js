    ...
    $http({
      ...
      function(response) {
        ...
        if (response.data.main.temp > 65 && response.data.main.temp < 80) {
          ...
          controller.water[response.data.name] = 32 + ' fluid ounces of water per two hours recommended'
          ...
          controller.water[response.data.name] = 36 + ' fluid ounces of water per two hours recommended'
